...
double ComputeMedianLidarPointsX(std::vector<LidarPoint> &lidarPoints)
{
                     ...
                     std::vector<LidarPoint> &lidarPointsCurr, double frameRate, double &TTC)
{
  ...
  double d0 = ComputeMedianLidarPointsX(lidarPointsPrev);
  double d1 = ComputeMedianLidarPointsX(lidarPointsCurr);
